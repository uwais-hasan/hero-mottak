...
const column = [
    createData('uwais hasan', 'actor_3.jpg','uwais@hero.com', '10-10-98', 'Admin', ),
    createData('eric noje', 'actor_2.jpg', 'uwais@hero.com', '10-10-98', 'supervisor',),
    createData('selfester stalon', 'actor_5.gif', 'selfester@hero.com', '10-10-98', 'supervisor', ),
    createData('jon carry',  'actor_6.jpg','carry@hero.com', '10-10-98', 'supervisor'),
    createData('gerald folos',  'actor_4.jpg','gerald@hero.com', '10-10-98', 'supervisor'),
];
// const columns = [
                    ...
                    {column.map((row,index) => (
                        <StyledTableRow key={row.name}>
                            ...
                            <StyledTableCell align='right'>
                                <Button variant='contained' color='error'>remove Admin</Button>
                            </StyledTableCell>
                        </StyledTableRow>
                    ))}
                </TableBody>
